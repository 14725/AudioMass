(function ( w, d, PKAE ) {
    ...
    ID3v2.frames = {
        ...
        "ETC" : "事件计时代码",
        "EQU" : "均衡器",
        "GEO" : "一般封装对象 (General encapsulated object)",
        "IPL" : "参与者名单",
        "LNK" : "链接信息",
        "MCI" : "音乐 CD 标识",
        "MLL" : "MPEG 定位表 (MPEG location lookup table)",
        "PIC" : "附加的图片",
        "POP" : "流行程度",
        "REV" : "翻转波形",
        "RVA" : "相对音量调整",
        "SLT" : "同步歌词/文本 (Synchronized lyric/text)",
        "STC" : "同步拍号代码 (Synced tempo codes)",
        "TAL" : "专辑/影片/演出标题 (Album/Movie/Show title)",
        "TBP" : "BPM (每分钟拍数)",
        "TCM" : "作曲家",
        "TCO" : "内容类型 (Content type)",
        "TCR" : "版权信息",
        "TDA" : "日期",
        "TDY" : "播放列表延迟",
        "TEN" : "编码器",
